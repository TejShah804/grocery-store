...
export default function BreadAndBakery() {
  ...
  const categoryProducts = products.filter(p => p.category === "Bread & Bakery");
  ...
  return (
    <>
      ...
      <div className="container my-5" style={{ minHeight: "60vh" }}>
        <h2 className="text-center mb-2">Bread & Bakery</h2>
        <p className="text-center text-muted mb-4">
          Fresh baked goodness delivered to your door
        </p>
